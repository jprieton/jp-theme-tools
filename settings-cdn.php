<div class="wrap">
		<h2>JP Theme Tools - Opciones de CDN</h2>
				...
				<table class="form-table">
						<tr valign="top">
								...
								<td>
										...
										<span class="cdn-update cdn-sprite icon-jquery" data-value="http://code.jquery.com/jquery-<?php echo $jquery_ver ?>.min.js"></span>
						...
						<tr valign="top">
								...
								<td>
										...
										<span class="cdn-update cdn-sprite icon-jquery" data-value="http://code.jquery.com/jquery-migrate-<?php echo $jquery_migrate_ver ?>.min.js"></span>
										<span class="cdn-update dashicons dashicons-no" data-value=""></span>
								</td>
						</tr>
				</table>
