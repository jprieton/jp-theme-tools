...
?>
<form class="navbar-form navbar-search-form <?php echo $form_class ?>" id="<?php echo $args['widget_id'] ?>" role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ) ?>" itemscope itemtype="http://schema.org/SearchAction">
